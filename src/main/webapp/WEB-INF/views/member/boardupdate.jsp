...
<link href="https://cdn.jsdelivr.net/npm/summernote@0.8.18/dist/summernote.min.css" rel="stylesheet"> 
  ...
  <script src=" https://cdnjs.cloudflare.com/ajax/libs/summernote/0.8.18/lang/summernote-ko-KR.min.js"></script>
	...
	<div class="container">
		<form action="writeupdate" method="post" enctype="multipart/form-data" name="write">
			<input type="hidden" name="b_num" value="${list.b_num }"> <input
				type="hidden" name="b_cate" value="${list.b_cate }"> <input
				type="hidden" name="m_nick" value="${list.m_nick }">
			<table border="1">
				<tr>
					<th>분류</th>
				...
				<tr>
					<th>내용</th>
					<td><textarea class="summernote" name="b_content" value="${list.b_content }"></textarea></td>
					<!-- summernote -->
				</tr>
				<tr>
					<th>첨부파일1</th>
				...
				<tr>
					...
					<button class="button" type="button" name="boardupdate" onclick="Board_write();">수정</button>
		</form>
		</div>
