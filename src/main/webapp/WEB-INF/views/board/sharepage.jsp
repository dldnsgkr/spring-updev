	...
	<!-- 정보공유 게시판 -->
		<div class="wrap">
			...
			<div class="board_write">
				<button class="button" type="button" name="board_write" onclick="location.href = 'write?b_kind=정보공유' ">
			...
			<table border="1">
				...
				<tbody id="tbody">
					...
					<tr>
						<td>${a.b_num }</td>
						<td><a href="detail?b_num=${a.b_num }&su_nick=${a.m_nick}&receiveread=a">${a.b_title }</a>
